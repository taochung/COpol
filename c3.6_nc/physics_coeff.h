...
#if OneD
	#define OBS_ANG 0.4*M_PI         //Observation angle (2D default: M_PI/2, 1D default: 0.4*M_PI)
...
//Number of levels
#define LEVEL_N 4                    //total level number (ex: 2:J=0 ~ 1)
...
//Temperature
#define TEMP_SELE 6                  //The collisional temperature column that was selected from the LAMDA data (start from 1)
